...
function EventData:on_occupant_joined(occupant_jid, event_origin)
    ...
    local occupant_data = {
        occupantJid   = occupant_jid;
        name  = user_context.name;
        id  = user_context.id;
        email  = user_context.email;
        orgId = user_context.orgId or "";
        joinedAt = now();
        leftAt = nil;
    };
...
function room_created(event)
    ...
    async_http_request(CONSUMER_URL, {
